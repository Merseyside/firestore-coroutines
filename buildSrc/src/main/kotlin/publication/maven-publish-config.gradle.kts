...
publishing {
    publications {
        withType<MavenPublication>().all {
            val projectGitUrl = "https://github.com/Merseyside/firestore-coroutines"
            artifact(tasks.named<Jar>("withSourcesJar"))
            artifact(javadocJar)
            pom {
                name.set("Firestore coroutine adapter")
                description.set("Mersey android firestore coroutine adapter")
